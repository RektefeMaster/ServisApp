-- Veli GUARDIAN-only üyeliği ilk JWT ile ACTIVE olmaz.
-- Personel/yönetici (ADMIN|DRIVER|ATTENDANT) ilk girişte ACTIVE kalır.
-- Çocuk listesi zaten student_guardian + ACTIVE üyelik ister; bu, tenant
-- kapsamını da davet aktivasyonuna bağlar (SPEC: veli yalnız aktive olur).
