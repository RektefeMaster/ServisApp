...
import { coordinate, instant, phoneE164, serviceDate } from './primitives.js';
...
describe('primitives', () => {
  ...
  it('UTC anını offset ile kabul eder', () => {
    expect(instant.safeParse('2026-09-10T05:30:00.000Z').success).toBe(true);
    expect(instant.safeParse('2026-09-10T05:30:00.000+00:00').success).toBe(true);
    expect(instant.safeParse('2026-09-10T05:30:00').success).toBe(false);
  });
